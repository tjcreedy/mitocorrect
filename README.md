...
| Argument                   | Description                                                                                                                                                                                                                 | Default                                                                                                          |
|----------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------|
| `-n`/`--namevariants`      | The path to a file specifying variant gene names to add to those retrieved from the list [here](https://github.com/tjcreedy/constants), in the same format                                                                   | *none*                                                                                                           |
